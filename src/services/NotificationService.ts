export class NotificationService {
  ...
  static async showClassReminder(classInfo: any) {
...
// /* console.log */ ('Notification permission denied');
  ...
  static async showScheduleUpdate(message: any) {
    const permission = await this.requestPermission();
    ...
    const notification = new Notification('Genatis Board', {
      body: message,
      icon: '/favicon.ico',
      tag: 'schedule-update'
    });
...
// /* console.error */ ('Error playing chime:', error);
  ...
  static async showReminderWithChime(classInfo: any) {
    // Play chime first
    this.playChime();
